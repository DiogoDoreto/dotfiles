# Regenerate with `nix run github:nix-community/plasma-manager > plasma.nix`
{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Window Custom Quick Tile Bottom" = "\\, ,,Custom Quick Tile Window to the Bottom";
    ...
    configFile = {
      ...
      "kwinrc"."Tiling/a4f39f6a-6e61-5a10-aba2-0d2da7cf0ee6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
